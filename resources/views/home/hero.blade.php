<div class="py-5 my-md-5 my-2 row">
    <div class="col-md-6">
        ...
        <p class="text-muted">At Lynx, you can get your job done as fast as possible using some of the best professionals in the world. Get started now</p>
        <div class="d-flex p-3 bg-white rounded shadow-sm">
            <div class="d-flex align-items-center">
                <i data-feather="search"></i>
            </div>
            <input type="text" class="bg-transparent border-0 ml-3 p-0 m-0 w-100 outline-0 mr-3" placeholder="Job title or keyword">
